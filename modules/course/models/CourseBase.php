...
class CourseBase extends \app\models\ModelApp
{
    ...
    {
        return [
            [['col_school_id', 'col_title_en', 'col_description_en'], 'required'],
            [['col_school_id'], 'integer'],
            [['col_description_en', 'col_price'], 'string'],
            [['col_title_en'], 'string', 'max' => 255],
            [['col_title_ru', 'col_title_es', 'col_title_ua', 'col_title_cn', 'col_price'], 'default', 'value' => ''],
